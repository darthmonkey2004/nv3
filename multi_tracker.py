...
class multi_tracker():
	...
	def add(self, img, box, class_name='Detection', tracker_type=None, confidence=None, max_age: int=200):
		...
		t = tracker(img=img, box=box, camera_id=self.camera_id, class_name=class_name, tracker_type=self.tracker_type, confidence=confidence, max_age=self.max_age)
		if t.success:
			self.trackers[idx] = t
